...
class CGAN(object):
    ...
    def coconv(self, input_tensor, x_dim, y_dim, with_r):
        """
    ...
    def _build_net(self):
        ...
        self.cc = self.coconv(self.X, 720, 720, True)


        self.g_samples = self.generator(self.cc)
        self.real_pair = tf.concat([self.cc, self.Y], axis=3)
        self.fake_pair = tf.concat([self.cc, self.g_samples], axis=3)
